...
describe('RandomTable', () => {
  describe('constructor', () => {
    ...
    it('should create a RandomTable with initial entries', () => {
      const entries = [new TableEntry('entry1', 'Entry 1'), new TableEntry('entry2', 'Entry 2')];
    ...
    it('should throw an error if id is empty', () => {
      expect(() => new RandomTable('', 'Test Table')).toThrow('Table ID is required');
    });

    it('should throw an error if name is empty', () => {
      expect(() => new RandomTable('table1', '')).toThrow('Table name is required');
    });
  });
  ...
  describe('addEntry', () => {
    ...
    it('should throw an error if entry with same ID already exists', () => {
      ...
      expect(() => table.addEntry(entry2)).toThrow('Entry with ID entry1 already exists');
    });
  });
  ...
  describe('removeEntry', () => {
    it('should remove an entry from the table', () => {
      ...
      const table = new RandomTable('table1', 'Test Table', '', [entry1, entry2]);
  ...
  describe('updateEntry', () => {
    ...
    it('should throw an error if entry does not exist', () => {
      const table = new RandomTable('table1', 'Test Table');
      expect(() => table.updateEntry('nonexistent', { content: 'Updated' })).toThrow(
        'Entry with ID nonexistent does not exist',
      );
    });
  });
  ...
  describe('roll', () => {
    ...
    it('should detect template entries when rolling', () => {
      ...
      const table = new RandomTable('table1', 'Test Table', '', [templateEntry, normalEntry]);
  ...
  describe('toObject', () => {
    it('should convert a RandomTable to a plain object', () => {
      ...
      const table = new RandomTable('table1', 'Test Table', 'A test table', entries);
