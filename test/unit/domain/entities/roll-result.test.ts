...
describe('RollResult', () => {
  describe('constructor', () => {
    ...
    it('should create a RollResult with custom timestamp', () => {
      ...
      const result = new RollResult('table1', 'entry1', 'Test Result', false, undefined, timestamp);
      expect(result.timestamp).toBe(timestamp);
    });

    it('should create a RollResult with template content', () => {
      const result = new RollResult('table1', 'entry1', 'Test {{reference::table2::name}}', true);
  ...
  describe('withResolvedContent', () => {
    it('should create a new RollResult with resolved content', () => {
      const result = new RollResult('table1', 'entry1', 'Test {{reference::table2::name}}', true);
      const resolvedResult = result.withResolvedContent('Test Resolved Content');
