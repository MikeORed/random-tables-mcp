import { CreateTableTool } from '../../../../src/adapters/primary/mcp/tools/create-table-tool';
...
describe('CreateTableTool Integration Tests', () => {
  ...
  it('should have the correct name and description', () => {
    ...
    expect(createTableTool.getToolDefinition().description).toBe(
      'Create a new random table. Table entries can include templates to reference other tables using the format {{reference-title::table-id::table-name::roll-number::separator}}.',
    );
  });
